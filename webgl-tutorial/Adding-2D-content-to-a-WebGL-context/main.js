...
function main() {
 ...
 // when we do our math, we will need it to be a vec4, 
 // so rather than convert it to a vec4 every time we do math, 
 // we'll just use a vec4 from the beginning. 
...
`;
  ...
  void main() {
    myOutputColor = vec4(1.0, 0, 1.0, 1.0);
  }
  `;
  ...
  we'll store them together to make them easy to pass around
  */
